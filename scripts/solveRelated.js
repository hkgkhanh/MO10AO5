...
function timeContain(param) {
	...
	if (session.length > 0) {
		...
		if (param === "session") {
			...
			text += timeContainAoX(25, 2, a25s, bestAo25Index);

		} else if (param === "cAo25") {
			text += timeContainAoX(25, 2, ao5s, ao25s.length - 1);

		} else if (param === "bAo50") {
			text += timeContainAoX(50, 3, ao50s, bestAo50Index);

		} else if (param === "cAo50") {
			text += timeContainAoX(50, 3, ao5s, ao50s.length - 1);
			...
			text += timeContainMo10Ao5(avgCount);
